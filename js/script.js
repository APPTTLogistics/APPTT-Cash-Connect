...
function animateToDot(i) {
    ...
    // Always recalculate position relative to parent
    const x = rect.left - parentRect.left + window.scrollX + dot.offsetWidth / 2;
    const y = rect.top - parentRect.top + window.scrollY + dot.offsetHeight / 2;
    ...
    // Adjust popup offset based on screen size
    const yOffset = window.innerWidth <= 600 ? 60 : 40;
